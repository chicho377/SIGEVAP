    ...
    public partial class FrmMenu : Form
    {
        ...
        private void ConfigurarStatsDashboard()
        {
            ...
            for (int i = 0; i < stats.Length; i++)
            {
                ...
                stats[i].Size = new Size(280, 120);
                stats[i].Controls.Clear();

                valores[i].AutoSize = false;
                valores[i].BackColor = Color.Transparent;
                valores[i].Font = new Font("Segoe UI", 30F, FontStyle.Bold);
                valores[i].ForeColor = C_AMARILLO;
                valores[i].Location = new Point(10, 14);
                valores[i].Size = new Size(260, 50);
                valores[i].Text = "0";
                ...
                etiquetas[i].Location = new Point(10, 72);
