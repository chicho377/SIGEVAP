...
namespace SIGEVAP.Views
{
    public partial class FrmMenu : Form
    {
        ...
        {
            lblWelcomeSub.Size = new Size(900, 28);
        ...
        private void ConfigurarCardsDashboard()
        {
            ...
            for (int i = 0; i < cards.Length; i++)
            {
                ...
                descripciones[i].Size = new Size(205, 56);
        ...
        private void ConfigurarStatsDashboard()
        {
            ...
            for (int i = 0; i < stats.Length; i++)
            {
                ...
                etiquetas[i].Location = new Point(14, 42);
                etiquetas[i].Size = new Size(185, 32);
